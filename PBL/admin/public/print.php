                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="border border-gray-300 p-4">
                            <img src="assets/gambar/<?php echo $data['gambar'] ?>" alt="Tidak Ada Lampiran" width="200">
                        </td>
                      </tr>
                      <tr>
                ...
                <table class="border-collapse w-full">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="border border-gray-300 p-4 font-semibold">Lampiran</td>
                        <td class="border border-gray-300 p-4">
                            <img src="assets/gambar/<?php echo $data['lampiran_admin'] ?>" alt="Tidak Ada Lampiran" width="200">
                        </td>
                      </tr>
                    </tbody>
                  </table>
