...
<body>
  <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen}">
    ...
    <?php include('includes/header.php') ?>
      ...
      <main class="h-full overflow-y-auto bg-gray-100">
        ...
        <form action="editprofiladmin.php?data=<?php echo $id_user ?>" method="post" enctype="multipart/form-data">
          <a href="Admin.php">
            <button
          ...
          <h2 class="my-6 mt-4 text-2xl font-semibold text-blue-950 dark:text-gray-200">
            Admin Detail
          </h2>
            ...
            <label class="block text-sm">
              <span class="text-gray-700 dark:text-gray-400">
                Foto Profil
                  ...
                  <img src="../../admin/public/assets/foto/<?php echo $data['foto']; ?>" alt="Tidak Ada Foto Profil" width="250" 
                    >
            </label>
  ...
  <script>
    function printDocument() {
      window.location.href = "printeditadmin.php?data=<?php echo $id_user ?>";
    }
  </script>
