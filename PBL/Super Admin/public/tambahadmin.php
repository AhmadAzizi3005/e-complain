...
<body>
  <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen}">
    ...
    <?php include('includes/header.php') ?>
      ...
      <form class="h-full overflow-y-auto"  action="konfirmasitambahpengguna.php" method="post" enctype="multipart/form-data">
        <div class="container px-6 mx-auto grid">
          ...
          <!-- General elements -->
          <h4 class="mb-4 mt-2 text-lg font-semibold text-white dark:text-gray-300">
            Identitas
          </h4>
          <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <label class="block text-sm">
              ...
              <select
                ...
                <option value="admin1">Departemen Bisnis dan Hospitality</option>
                <option value="admin2">Departemen Industri Kreatif dan Digital</option>
              </select>
            </label>
