          ...
          <div>
            <table class="border-collapse w-full">
              ...
              <?php 
                ...
                ?>
                <tr>
                  <td class="border border-gray-300 p-4"><center><?php echo $no++ ?></td>
                  ...
                  <td class="border border-gray-300 p-4"><center><?php echo $data['departemen'] ?></td>
                  <td class="border border-gray-300 p-4"><center><?php echo $data['email'] ?></td>
                  <td class="border border-gray-300 p-4"><center><?php echo $data['password'] ?></td>
                </tr>
              </tbody>
              <?php } ?>
            </table>
