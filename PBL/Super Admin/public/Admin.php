                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3">
                        <div class="flex items-center justify-center space-x-4 text-sm">
                          <a href="Admin Detail.php?data=<?php echo $data['id_user'] ?>">
                          <button
                          ...
                          <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $data['nama']; ?>?'))window.location.href ='Admin.php?aksi=hapus&data=<?php echo $data['id_user']; ?>&notif=hapusberhasil'" 
    ...
    <footer class="py-4 bg-white dark:bg-gray-800 mt-4">
      ...
      <script>
        function printDocument() {
          window.location.href = "printadmin.php";
        }
      </script>
