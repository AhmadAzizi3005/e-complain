...
<body class="flex flex-col h-screen">
  <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen}">
   ...
   <?php include('includes/header.php') ?>
      ...
      <main class="h-full pb-16 overflow-y-auto bg-gray-100 flex-grow ">
              ...
              <table class="w-full min-w-full hover" id="example">
                ...
                if(!empty($_GET['status'])){
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3"><center>
                      <p class="font-semibold"><?php echo $data['angka_random'];?></p>
                    </td>
                    ...
                    <td class="px-4 py-3"><center>
                    <div class="flex item-center justify-center text-sm">
                        <a href="forms.php?data=<?php echo $data['angka_random'] ?>">
                        <button
